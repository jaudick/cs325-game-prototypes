...
class MyScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image( 'logo', 'assets/Otto-I-the-Great.-Holy-Roman-Emperor-Duke-of-Saxony.jpg' );
    }
    ...
    create() {
        ...
        let text = this.add.text( this.cameras.main.centerX, 15, "Hello, Jacob Audick.", style );
